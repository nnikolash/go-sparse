...
func NewSeriesEntry[Data any, Index any](
...
type SeriesEntry[Data any, Index any] struct {
	storageFactory SeriesDataFactory[Data, Index]
	getIdx         func(data *Data) Index
	idxCmp         func(idx1, idx2 Index) int
	areContinuous  func(smaller, bigger Index) bool
...
func (e *SeriesEntry[Data, Index]) GetAll() ([]Data, error) {
	if e.Data == nil {
...
func (e *SeriesEntry[Data, Index]) GetAllInRange(minPeriodStart, maxPeriodEnd Index) (fetchedPeriodStart, fetchedPeriodEnd Index, data []Data, _ error) {
	if e.Data == nil {
	...
	if e.idxCmp(e.PeriodEnd, minPeriodStart) < 0 || e.idxCmp(e.PeriodStart, maxPeriodEnd) > 0 {
		return fetchedPeriodStart, fetchedPeriodEnd, nil, errors.Errorf("entry period is out of range: entry = [ %v ; %v ], range = [ %v ; %v ]",
...
func (e *SeriesEntry[Data, Index]) First() (*Data, error) {
	if e.Data == nil {
		return nil, nil
	}
...
func (e *SeriesEntry[Data, Index]) Last() (*Data, error) {
	if e.Data == nil {
		return nil, nil
	}
...
func (e *SeriesEntry[Data, Index]) ContainsPoint(t Index) bool {
	if e.Data == nil {
		return false
	}
...
func (e *SeriesEntry[Data, Index]) CanBeMergedWith(t Index) bool {
	if e.Data == nil {
		return false
	}
...
func (e *SeriesEntry[Data, Index]) MergeData(data []Data) error {
	if len(data) == 0 {
		return nil
	}
...
func (e *SeriesEntry[Data, Index]) MergePeriod(periodStart, periodEnd Index, data []Data) error {
...
func (e *SeriesEntry[Data, Index]) validateDataBounds(periodStart, periodEnd Index, data []Data) error {
...
func (e *SeriesEntry[Data, Index]) checkHaveIntersectionWithPeriod(periodStart, periodEnd Index) error {
	if e.Data == nil {
		return nil
	}
...
func (e *SeriesEntry[Data, Index]) getBiggerIndex(idx1, idx2 Index) Index {
...
func (e *SeriesEntry[Data, Index]) getSmallerIndex(idx1, idx2 Index) Index {
	if e.idxCmp(idx1, idx2) < 0 {
		return idx1
	}
